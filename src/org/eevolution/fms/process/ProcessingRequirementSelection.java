...
import org.idempiere.tms.model.MDDRequirement;
import org.idempiere.tms.model.MDDRequirementAssignment;
...
public class ProcessingRequirementSelection extends ProcessingRequirementSelectionAbstract {
    ...
    protected String doIt() throws Exception {
        ...
        if (getRecord_ID() > 0 && getSelectionKeys().size() > 0 && getTableSelectionId() == MDDRequirement.Table_ID) {
            ...
            if (getProcessInfo().getTable_ID() == MDDVehicle.Table_ID) {
                MDDVehicle vehicle = (MDDVehicle) getInstance2(get_TrxName());
  ...
  //maximea hard code<	
  	private MDDDriver getInstance(String get_TrxName) {
  		// TODO Auto-generated method stub
  		return null;
  	}
  	private MDDVehicle getInstance2(String get_TrxName) {
  		// TODO Auto-generated method stub
  		return null;
  	}
  	...
  	private List<MDDRequirement> getInstancesForSelection(String get_TrxName) {
  		// TODO Auto-generated method stub
  		return null;
  	}
