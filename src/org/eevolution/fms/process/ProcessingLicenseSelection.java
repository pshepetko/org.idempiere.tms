...
import org.idempiere.tms.model.MDDLicense;
import org.idempiere.tms.model.MDDLicenseAssignment;
...
public class ProcessingLicenseSelection extends ProcessingLicenseSelectionAbstract {
    ...
    protected String doIt() throws Exception {
        ...
        if (getRecord_ID() > 0 && getSelectionKeys().size() > 0 && getTableSelectionId() == MDDLicense.Table_ID) {
            ...
            if (getProcessInfo().getTable_ID() == MDDDriver.Table_ID) {
                MDDDriver driver = (MDDDriver) getInstance2(get_TrxName());
  ...
  //maximea hard code<	
  	private MDDVehicle getInstance(String get_TrxName) {
  		// TODO Auto-generated method stub
  		return null;
  	}
  	
  	private MDDDriver getInstance2(String get_TrxName) {
  		// TODO Auto-generated method stub
  		return null;
  	}
  	...
  	private List<MDDLicense> getInstancesForSelection(String get_TrxName) {
  		// TODO Auto-generated method stub
  		return null;
  	}
