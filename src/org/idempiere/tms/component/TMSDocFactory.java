...
import org.idempiere.acct.Doc_DDFreight;
import org.idempiere.tms.model.I_DD_Freight;

public class TMSDocFactory implements IDocFactory {
	private final static CLogger s_log = CLogger.getCLogger(TMSDocFactory.class);
