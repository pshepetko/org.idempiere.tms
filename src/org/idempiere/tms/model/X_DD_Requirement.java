...
public class X_DD_Requirement extends PO implements I_DD_Requirement, I_Persistent 
{
	...
	public org.idempiere.tms.model.I_DD_RequirementType getDD_RequirementType() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_RequirementType)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_RequirementType.Table_Name)
