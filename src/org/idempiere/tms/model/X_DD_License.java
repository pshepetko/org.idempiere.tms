...
public class X_DD_License extends PO implements I_DD_License, I_Persistent 
{
	...
	public org.idempiere.tms.model.I_DD_LicenseType getDD_LicenseType() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_LicenseType)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_LicenseType.Table_Name)
