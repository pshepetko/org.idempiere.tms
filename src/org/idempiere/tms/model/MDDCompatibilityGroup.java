...
public class MDDCompatibilityGroup extends X_DD_CompatibilityGroup {
     ...
     * @param ctx
     * @param compatibilitygroupId
     * @param trxName
     */
    public MDDCompatibilityGroup(Properties ctx, int compatibilitygroupId, String trxName) {
        super(ctx, compatibilitygroupId, trxName);
    }
     ...
     * @param trxName
     */
    public MDDCompatibilityGroup(Properties ctx, ResultSet rs, String trxName) {
