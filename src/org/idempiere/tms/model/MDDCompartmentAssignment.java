...
public class MDDCompartmentAssignment extends X_DD_CompartmentAssignment{
    ...
    /**
     * Constructor Compartment Assignment
     * @param ctx
     * @param compartmentassignmentId
     * @param trxName
     */
    public MDDCompartmentAssignment(Properties ctx, int compartmentassignmentId, String trxName) {
        super(ctx, compartmentassignmentId, trxName);
    }
