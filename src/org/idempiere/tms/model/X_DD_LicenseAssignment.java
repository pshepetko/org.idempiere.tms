...
public class X_DD_LicenseAssignment extends PO implements I_DD_LicenseAssignment, I_Persistent 
{
	...
	public org.idempiere.tms.model.I_DD_License getDD_License() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_License)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_License.Table_Name)
