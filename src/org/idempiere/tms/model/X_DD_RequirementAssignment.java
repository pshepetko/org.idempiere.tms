...
public class X_DD_RequirementAssignment extends PO implements I_DD_RequirementAssignment, I_Persistent 
{
	...
	public org.idempiere.tms.model.I_DD_Driver getDD_Driver() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_Driver)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_Driver.Table_Name)
	...
	public org.idempiere.tms.model.I_DD_Requirement getDD_Requirement() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_Requirement)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_Requirement.Table_Name)
	...
	public org.idempiere.tms.model.I_DD_Vehicle getDD_Vehicle() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_Vehicle)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_Vehicle.Table_Name)
