...
public class X_DD_Vehicle extends PO implements I_DD_Vehicle, I_Persistent 
{
	...
	public org.idempiere.tms.model.I_DD_CompatibilityGroup getDD_CompatibilityGroup() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_CompatibilityGroup)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_CompatibilityGroup.Table_Name)
	...
	public org.idempiere.tms.model.I_DD_DriverAssignment getDD_DriverAssignment() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_DriverAssignment)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_DriverAssignment.Table_Name)
	...
	public org.idempiere.tms.model.I_DD_LicenseAssignment getDD_LicenseAssignment() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_LicenseAssignment)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_LicenseAssignment.Table_Name)
	...
	public org.idempiere.tms.model.I_DD_RequirementAssignment getDD_RequirementAssignment() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_RequirementAssignment)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_RequirementAssignment.Table_Name)
	...
	public org.idempiere.tms.model.I_DD_VehicleType getDD_VehicleType() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_VehicleType)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_VehicleType.Table_Name)
