...
public class MDDVehicleType extends X_DD_VehicleType {
     ...
     * @param trxName
     */
    public MDDVehicleType(Properties ctx, int vehicleTypeId, String trxName) {
        super(ctx, vehicleTypeId, trxName);
    }
     ...
     * @param trxName
     */
    public MDDVehicleType(Properties ctx, ResultSet rs, String trxName) {
