...
/** Generated Model for DD_CompatibilityGroup
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_DD_CompatibilityGroup extends PO implements I_DD_CompatibilityGroup, I_Persistent 
{
    ...
    {
      super (ctx, DD_CompatibilityGroup_ID, trxName);
      /** if (DD_CompatibilityGroup_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_DD_CompatibilityGroup (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_DD_CompatibilityGroup[")
	...
	public void setDD_CompatibilityGroup_ID (int DD_CompatibilityGroup_ID)
	{
		if (DD_CompatibilityGroup_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_DD_CompatibilityGroup_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_DD_CompatibilityGroup_ID, Integer.valueOf(DD_CompatibilityGroup_ID));
	}
