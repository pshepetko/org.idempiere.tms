...
public class MDDLicenseType extends X_DD_LicenseType {
     ...
     * @param trxName
     */
    public MDDLicenseType(Properties ctx, int licensetypeId, String trxName) {
        super(ctx, licensetypeId, trxName);
    }
     ...
     * @param trxName
     */
    public MDDLicenseType(Properties ctx, ResultSet rs, String trxName) {
