...
public class MDDRequirementType extends X_DD_RequirementType {
     ...
     * @param trxName
     */
    public MDDRequirementType(Properties ctx, int requirementTypeId, String trxName) {
        super(ctx, requirementTypeId, trxName);
    }
     ...
     * @param trxName
     */
    public MDDRequirementType(Properties ctx, ResultSet rs, String trxName) {
