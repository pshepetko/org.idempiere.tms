...
public class X_DD_CompartmentAssignment extends PO implements I_DD_CompartmentAssignment, I_Persistent 
{
	...
	public org.idempiere.tms.model.I_DD_Compartment getDD_Compartment() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_Compartment)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_Compartment.Table_Name)
	...
	public org.idempiere.tms.model.I_DD_TransportUnit getDD_TransportUnit() throws RuntimeException
    {
		return (org.idempiere.tms.model.I_DD_TransportUnit)MTable.get(getCtx(), org.idempiere.tms.model.I_DD_TransportUnit.Table_Name)
