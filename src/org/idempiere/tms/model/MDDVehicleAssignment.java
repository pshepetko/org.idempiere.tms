...
public class MDDVehicleAssignment extends X_DD_VehicleAssignment {
    ...
    /**
     * Constructor Vehicle Assignment
     * @param ctx
     * @param vehicleAssignmentId
     * @param trxName
     */
    public MDDVehicleAssignment(Properties ctx, int vehicleAssignmentId, String trxName) {
        super(ctx, vehicleAssignmentId, trxName);
    }
     ...
     * @param trxName
     */
    public MDDVehicleAssignment(Properties ctx, ResultSet rs, String trxName) {
